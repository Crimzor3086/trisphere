// --- Global State ---
    ...
    const contractAbi = [
      ...
      "function creatorReputation(address) public view returns (uint256)",
    ...
    let liveTrends = [];
    const API_BASE = localStorage.getItem("trend_hunter_api_base")
      || `${window.location.origin}/api/trend`;
